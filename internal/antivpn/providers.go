...
func (p *proxyCheckProvider) Lookup(ctx context.Context, ip netip.Addr) ProviderResult {
	...
	result.CountryName = anyValueString(body["country"])
	result.CountryCode = anyValueString(body["isocode"])
...
func (p *ipapiISProvider) Lookup(ctx context.Context, ip netip.Addr) ProviderResult {
	...
	result.Success = true
	result.CountryName = firstNonEmpty(payload.Country, payload.Location.Country)
	result.CountryCode = firstNonEmpty(payload.CountryCode, payload.Location.CountryCode)
	summaryParts := []string{}
	if payload.IsVPN {
...
func (p *ipHubProvider) Lookup(ctx context.Context, ip netip.Addr) ProviderResult {
	...
	result.Success = true
	result.CountryName = payload.CountryName
...
func (p *ipLocateProvider) Lookup(ctx context.Context, ip netip.Addr) ProviderResult {
	...
	result.Success = true
	result.CountryName = payload.Country
	result.CountryCode = payload.CountryCode
	summaryParts := []string{}
...
func (p *vpnAPIIoProvider) Lookup(ctx context.Context, ip netip.Addr) ProviderResult {
	...
	result.Success = true
	result.CountryName = payload.Location.Country
	result.CountryCode = payload.Location.CountryCode
