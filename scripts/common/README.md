...
| `jka_addon_loader.sh`             | `sync_addon_docs`, `sync_image_managed_addon_tree`, `sync_managed_addon_defaults`, `sync_managed_addon_default_configs`, `cleanup_stale_live_output_files`, `install_managed_python_announcer_helper`, `install_managed_live_team_announcer_helper`, `install_managed_chatlogger_helper`, `install_managed_event_addon`, `addon_config_enabled`, `configure_addons`, `print_addon_summary`, `run_addons`. |
