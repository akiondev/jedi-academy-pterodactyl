...
print_header() {
  printf '%s\n' "============================================================"
  printf '%s\n' " TaystJK legacy32 (experimental) Installer"
  printf '%s\n' " Created by akiondev"
  printf '%s\n\n' "============================================================"
}
...
prepare_selected_mod_directory() {
  ...
  warn "TaystJK legacy32 (experimental) does not auto-prepare any mod directories. Upload your mod folder into ${mod_path} before startup"
}
...
seta sv_hostname "TaystJK legacy32 (experimental) Pterodactyl Server"
seta g_motd "Powered by TaystJK legacy32 (experimental) on Pterodactyl"
