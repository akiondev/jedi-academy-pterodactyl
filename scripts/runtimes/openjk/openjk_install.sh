...
prepare_selected_mod_directory() {
  ...
  warn "OpenJK does not auto-prepare any mod directories. Upload your mod folder into ${mod_path} before startup"
}
...
: "${SERVER_BINARY:=./openjkded.x86_64}"
: "${FS_GAME_MOD:=base}"
...
seta sv_hostname "OpenJK Pterodactyl Server"
seta g_motd "Powered by OpenJK on Pterodactyl"
